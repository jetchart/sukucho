...
CREATE TABLE `USUARIO` (
  ...
  `nivel_id` int(11) NOT NULL DEFAULT '2',
  PRIMARY KEY (`id`)
...
INSERT INTO `USUARIO` VALUES (1,'Juan','Etchart','juanmetchart@gmail.com','argento1',1),(1151,'Leandro','Tessore','ltessore@gmail.com','argento1',2);
